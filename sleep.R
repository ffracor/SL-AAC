...
res_sw <- boot(x,get_alpha_SW,R=10000, parallel = "multicore")
MSE_SW <- res_sw[["t"]]
...
# Use boot() function to perform bootstrap simulations
res_lasso <- boot(X,get_alpha_L,R=10000, parallel = "multicore")
...
# Use boot() function to perform bootstrap simulations
res_ridge <- boot(X,get_alpha_ridge,R=10000, parallel = "multicore")
...
res_boost <- boot(x,get_alpha_boost,R=10000, parallel = "multicore") #attenzione 'x' minuscola in questo caso
